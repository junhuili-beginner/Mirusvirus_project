...
command_template = "diamond blastp --ultra-sensitive --max-target-seqs 1 --evalue 0.00001 --threads 20 -d mirusvirus_mcp -q {query} -o {output}"
...
for faa_file in faa_files:
    ...
    output_file = f"{identifier}_Match2_mirusvirus_MCP_db.tsv"
